...
DEFINE_CURL_CONSTANT(CURLOPT_WRITEDATA)
...
// Http version
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_NONE);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_1_0);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_1_1);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_2);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_2TLS);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_3);
DEFINE_CURL_CONSTANT(CURL_HTTP_VERSION_3ONLY);
...
DECLARE_MODULE_METHOD(curl__easy_setopt) {
  ...
  } else if(IS_FILE(args[2])) {
    result = curl_easy_setopt(curl, opt, AS_FILE(args[2])->file);
...
CREATE_MODULE_LOADER(curl) {
  ...
  static z_field_reg module_fields[] = {
      ...
      GET_CURL_CONSTANT(CURLOPT_WRITEDATA),
      ...
      // versions
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_NONE),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_1_0),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_1_1),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_2),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_2TLS),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_3),
      GET_CURL_CONSTANT(CURL_HTTP_VERSION_3ONLY),
