 ...
 * Zuri out of the multiple core Zuri header files in the project.
 * 
 * The generated file can be imported by library authors to compile 
 * code that links against libzuri.
 * 
...
if !os.dir_exists('zuri/includes')
  os.create_dir('zuri/includes')
if !os.dir_exists('zuri/dist')
  os.create_dir('zuri/dist')


var output_file = 'zuri/includes/zuri.h'
...
var output = '/**
 * This file was autogenerated by make_zuri.b and should
 * NOT be manually modified as any manual modification will be 
 * lost whenever the script is run. This file is meant to be 
 * part of the final Zuri distribution as a single header file
 * that allow developers link against libzuri when writing
